...
root = Tk()
root.title('Student Utility App')
root.geometry("450x400+100+200")
root.configure(bg="black")
labelfont = ('ariel', 56, 'bold')
l=Label(root,text='Student Utility App',font = ("Arial", 25, "italic"), justify = CENTER)
l.place(x=47.5,y=10)

widget = Button(None, text="QUIT", bg="black", fg="red",font = ("Arial", 14, "bold"), relief = RAISED, bd=5, justify = CENTER, highlightbackground = "red", overrelief = GROOVE, activebackground = "green", activeforeground="blue", command=root.destroy).place(x=350,y=350)
...
def CurrencyConverter():
    ...
    ttk.Entry(mainframe, textvariable=out_amt, state="readonly").grid(column=2, row=3, sticky=(S, W))
